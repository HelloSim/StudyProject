...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private String path = Environment.getExternalStorageDirectory().toString() + "/Translation/log";
    ...
    private boolean saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                FileOutputStream fos = new FileOutputStream(path + "/translation-" + formatter.format(new Date()) + "-" + timestamp + ".log");
