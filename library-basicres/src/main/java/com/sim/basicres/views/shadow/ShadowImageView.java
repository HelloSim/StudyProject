...
public class ShadowImageView extends RelativeLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        int imageresource = -1;
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.common_ShadowImageView);
            if (a.hasValue(R.styleable.common_ShadowImageView_common_shadowSrc)) {
                imageresource = a.getResourceId(R.styleable.common_ShadowImageView_common_shadowSrc, -1);
            }
            shadowRound = a.getDimensionPixelSize(R.styleable.common_ShadowImageView_common_shadowRound, shadowRound);
            if (a.hasValue(R.styleable.common_ShadowImageView_common_shadowColor)) {
                shadowColor = a.getColor(R.styleable.common_ShadowImageView_common_shadowColor, Color.parseColor("#8D8D8D"));
            }
        } else {
