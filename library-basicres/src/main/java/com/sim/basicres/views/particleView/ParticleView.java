package com.sim.basicres.views.particleView;
...
/**
 * 闪屏页的粒子动画
 * Github: https://github.com/JeasonWong/Particle
 */
public class ParticleView extends View {
    ...
    private ParticleView.ParticleAnimListener mParticleAnimListener;
    ...
    private void initView(AttributeSet attrs) {
        ...
        TypedArray typeArray = getContext().obtainStyledAttributes(attrs, R.styleable.common_particleView);
        mHostText = null == typeArray.getString(R.styleable.common_particleView_common_host_text) ? "" : typeArray.getString(R.styleable.common_particleView_common_host_text);
        mParticleText = null == typeArray.getString(R.styleable.common_particleView_common_particle_text) ? "" : typeArray.getString(R.styleable.common_particleView_common_particle_text);
        mParticleTextSize = (int) typeArray.getDimension(R.styleable.common_particleView_common_particle_text_size, DEFAULT_MIN_TEXT_SIZE);
        int hostTextSize = (int) typeArray.getDimension(R.styleable.common_particleView_common_host_text_size, DEFAULT_MIN_TEXT_SIZE);
        mBgColor = typeArray.getColor(R.styleable.common_particleView_common_background_color, 0xFF0867AB);
        mParticleColor = typeArray.getColor(R.styleable.common_particleView_common_text_color, 0xFFCEF4FD);
        mTextAnimTime = typeArray.getInt(R.styleable.common_particleView_common_text_anim_time, DEFAULT_TEXT_ANIM_TIME);
        mSpreadAnimTime = typeArray.getInt(R.styleable.common_particleView_common_text_anim_time, DEFAULT_SPREAD_ANIM_TIME);
        mHostTextAnimTime = typeArray.getInt(R.styleable.common_particleView_common_text_anim_time, DEFAULT_HOST_TEXT_ANIM_TIME);
        typeArray.recycle();
    ...
    private void startParticleAnim() {
        ...
        set.addListener(new ParticleView.AnimListener() {
            @Override
    ...
    private void startSpreadAnim() {
        ...
        animator.addListener(new ParticleView.AnimListener() {
            @Override
            public void onAnimationEnd(Animator animation) {
                startHostTextAnim();
            }
    ...
    public void setOnParticleAnimListener(ParticleView.ParticleAnimListener particleAnimListener) {
