...
import com.sim.traveltool.bean.RouteDataBean;
...
public class RouteAdapter extends RecyclerView.Adapter<RouteAdapter.ViewHolder> {
    ...
    public RouteAdapter(Context mContext, ArrayList<RouteDataBean.RouteBean.TransitsBean> routeDataList) {
    ...
    public void onBindViewHolder(@NonNull RouteAdapter.ViewHolder holder, int position) {
        if (routeDataList != null) {
            ArrayList<RouteDataBean.RouteBean.TransitsBean.SegmentsBean> segmentsBeanArrayList = new ArrayList<>();
            segmentsBeanArrayList.addAll(routeDataList.get(position).getSegments());
            ArrayList<RouteDataBean.RouteBean.TransitsBean.SegmentsBean.BusBean.BuslinesBean> buslinesBeanArrayList = new ArrayList<>();
