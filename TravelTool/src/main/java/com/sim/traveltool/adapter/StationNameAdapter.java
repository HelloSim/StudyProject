...
import com.sim.traveltool.bean.LocationDataBean;
 ...
 */
public class StationNameAdapter extends RecyclerView.Adapter<StationNameAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<LocationDataBean.TipsBean> startStationDataList = new ArrayList<>();

    private onItemClickListener mOnItemClickListerer;

    public StationNameAdapter(Context mContext, ArrayList<LocationDataBean.TipsBean> startStationDataList) {
