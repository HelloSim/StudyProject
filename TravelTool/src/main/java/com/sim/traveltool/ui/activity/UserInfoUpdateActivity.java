...
public class UserInfoUpdateActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        updateNikeNamePopupWindow.setWidth(ScreenUtils.dip2px(context, updateNikeNamePupDPWidth));//宽度
        updateNikeNamePopupWindow.setHeight(ScreenUtils.dip2px(context, updateNikeNamePupDPHeight));//高度
        ...
        updateAutographNamePopupWindow.setWidth(ScreenUtils.dip2px(context, updateAutographPupDPWidth));//宽度
        updateAutographNamePopupWindow.setHeight(ScreenUtils.dip2px(context, updateAutographPupDPHeight));//高度
